 ...
 * @param {string} filepath - Ruta del archivo en el repositorio
 * @param {string} branch - Rama del repositorio
 * @returns {Promise<{notes: Array, labels: Array, updatedAt: string}>} Datos decodificados
 */
 ...
 * @param {string} filepath - Ruta del archivo en el repositorio
 * @param {string} branch - Rama del repositorio
 * @param {{notes: Array, labels: Array}} backupData - Datos a respaldar (excluyendo config)
...
export async function uploadBackup(token, repo, filepath, branch = 'main', backupData) {
    ...
    const body = {
        message: 'Update NTB notes backup [skip ci]',
